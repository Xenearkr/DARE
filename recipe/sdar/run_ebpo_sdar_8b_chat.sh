...
# validate algorithm
valid_algorithms=("d1" "coupled-grpo" "mdpo" "cj-grpo" "spg" "bgpo" "ebpo")
...
if [ $task == "math" ]; then
    ...
    # train_files="['data/preprocessed/rl/train/math_1.parquet']"
    # val_files="['data/preprocessed/rl/test/math500_1.parquet']"
...
python3 -m verl.trainer.dllm_main_ppo \
    ...
    +actor_rollout_ref.rollout.max_running_requests=4 \
