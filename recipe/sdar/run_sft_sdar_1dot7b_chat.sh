...
echo "Usage: run_sft_sdar_1dot7b_chat.sh <nproc_per_node> <model_path> [other_configs...]"

nproc_per_node=${1:-8}
MODEL_PATH=${2:-models/SDAR-1dot7B-Chat}

PROJECT_NAME=$WANDB_PROJECT
EXP_NAME="gsm8k-sft-full-sdar-1.7b-chat"
