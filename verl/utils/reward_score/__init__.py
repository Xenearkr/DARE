...
from .math_reward import math_rm
...
def dllm_rm(data_source, solution_str, ground_truth, extra_info=None) -> dict:
    ...
    Returns:
        Reward dict for the task
    """
    if extra_info["task"] == "math":
        res = math_rm(data_source, solution_str, ground_truth, extra_info)
        return res
...
__all__ = ["default_compute_score", "dllm_rm"]
