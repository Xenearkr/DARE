...
from .rollout_utils import execute_fastcjdream_generation

__all__ = ["FASTDLLMRollout"]
...
class FASTDLLMRollout(BaseRollout):
    ...
    def generate_sequences(self, prompts: DataProto, **kwargs) -> DataProto:
        ...
        n_rollout = 1 if is_validate else self.n_rollout  # In validation stage, input has been repeated val_kwargs.n times in ray_trainer._validate
        gen_kwargs = {
        ...
        responses, reversed_traj_unmask_positions, full_input_ids, attention_mask, answers = execute_fastcjdream_generation(
